package edu.ucsb.cs56.w16.drawings.kctoombs.simple;
...
/**
   ...
   @author Kenneth Toombs (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("A House and a Snowman, Kenneth Toombs", 20,20);
