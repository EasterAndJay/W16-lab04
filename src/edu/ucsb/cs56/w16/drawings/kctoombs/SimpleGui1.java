package edu.ucsb.cs56.w16.drawings.kctoombs;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Ain't nobody messin' with my Click (me)") ;
	
	java.awt.Color myColor = new java.awt.Color(153,0,204);   // R, G, B values.
