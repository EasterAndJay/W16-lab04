package edu.ucsb.cs56.w16.drawings.athielk.simple;
...
/**
   ...
   @author Alex Thielk (fixed the snowmans's head)
...
{  
	...
	Circle snowManTopCircle=
	    ...
	    (
	     snowManCenterBottomX,
	     snowManCenterBottomY-topRadius-(2*bottomRadius)-(2*middleRadius),
	     topRadius
	     );
	g2.draw(snowManTopCircle);
        g2.drawString("A snowman next to a house by Alex", 20,20);
