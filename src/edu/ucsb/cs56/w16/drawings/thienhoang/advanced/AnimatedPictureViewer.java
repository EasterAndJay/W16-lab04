...
/** A viewer class to see an animated picture by Thien Hoang
...
public class AnimatedPictureViewer extends JFrame
{
    ...
    static final double x = 300;
    static final double y = 80;
    static final double width = 100;
    static final double height = 300;
    static final double shrinkSpeed = 0.5;
    static final double initAngle = 0.00;
	...
	// Set your own title
	setTitle("Thien Hoang's Animted Drawing");
	...
	component = new AnimatedPictureComponent(x,y,width,height,shrinkSpeed,initAngle);
