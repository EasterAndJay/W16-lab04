...
public class AnimatedPictureViewer extends JFrame
{
    ...
    static final double startingXPos = 600;
    static final double startingYPos = 400;
    static final double travelSpeed = 1.6;
    static final double jumpHeight = 50;
	...
	// Set your own title
	setTitle("Marco's Animated Robots");
