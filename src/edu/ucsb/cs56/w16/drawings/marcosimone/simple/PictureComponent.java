package edu.ucsb.cs56.w16.drawings.marcosimone.simple;
...
/**
   ...
   @author Marco Simone (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Fixed the snowman's head - Marco Simone", 20,20);
